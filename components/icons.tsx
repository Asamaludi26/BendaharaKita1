...
export const BalanceIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0115.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 013 6h-.75m0 0v-.75A.75.75 0 012.25 4.5h.75m0 0A.75.75 0 013 5.25v.75A.75.75 0 012.25 6h-.75m16.5-1.5v.75a.75.75 0 00.75.75h.75m0 0c-.727.198-1.453.342-2.176.465a58.42 58.42 0 01-1.638.205M19.5 6h-.75a.75.75 0 00-.75.75v.75c0 .414.336.75.75.75h.75m0 0a.75.75 0 00.75-.75V6.75a.75.75 0 00-.75-.75M3.75 12h16.5m-16.5 0a9 9 0 01-1.897-1.743l-.002-.003A9 9 0 0112 3c5.058 0 9.156 4.18 9.156 9.343 0 .162-.007.324-.021.485M3.75 12a9 9 0 00-1.897 1.743l-.002.003A9 9 0 0012 21c5.058 0 9.156-4.18 9.156-9.343 0-.162.007.324.021-.485" />
    </svg>
);
...
export const WalletIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 01-2.25 2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 013 12V5.25A2.25 2.25 0 015.25 3h13.5A2.25 2.25 0 0121 5.25V12z" />
...
export const AccountsIcon: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V3m0 0l-3.75 3.75M12 3l3.75 3.75" />
